...
RSpec.describe "Api::V1::Auth::Registrations", type: :request do
  describe "POST /api/v1/auth" do
    ...
    context "password_confirmationの値がpasswordと異なるとき" do
      let(:params) { attributes_for(:user, password: "password", password_confirmation: "docker-composeexec") }
      it "ユーザー登録できないこと" do
        subject
  ...
  describe "POST /api/v1/auth/sign_in" do
    ...
    context "email,passwordが正しいとき" do
    ...
    context "emailが正しくないとき" do
      let(:current_user) { create(:user) }
      let(:params) { { email: "docker-compose@example.com", password: current_user.password } }
      it "ログインできないこと" do
        subject
